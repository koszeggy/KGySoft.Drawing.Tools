...
If an image or icon instance is debugged in a non read-only context, then it can be replaced and the palette entries of non read-only indexed bitmaps can be edited.

![Debugging Palette](https://kgysoft.net/images/DebugPalette.png)

## Installing Debugger Visualizers

* For Visual Studio 2013 and above you can use this VSIX installer (tested with Visual Studio 2015, 2017, 2019). It will install the .NET 4.5 version.
...
**Q:** Is Visual Studio Core supported?
