...
///////////////////////////////////////////////////////////////////////////////
//  File: ColorPaletteDebuggerVisualizerProviderImpl.cs
///////////////////////////////////////////////////////////////////////////////
...
{
    /// <summary>
    /// Provides the implementation of a debugger visualizer extension for the <see cref="ColorPalette"/> class.
    /// </summary>
    public class ColorPaletteDebuggerVisualizerProviderImpl : IDebuggerVisualizerProvider
    {
        #region Properties

        /// <summary>
        /// Gets the configuration of the color palette debugger visualizer provider.
        /// </summary>
        public DebuggerVisualizerProviderConfiguration DebuggerVisualizerProviderConfiguration
            => new("KGy SOFT ColorPalette Debugger Visualizer", typeof(ColorPalette))
            {
        ...
        /// <summary>
        /// Gets the view of the color palette debugger visualizer.
        /// </summary>
        ...
        public async Task<IRemoteUserControl> CreateVisualizerAsync(VisualizerTarget visualizerTarget, CancellationToken cancellationToken)
        {
            ...
            var result = new VisualizerExtensionWpfAdapter<ColorPalette>(visualizerTarget,
                (pal, vt) => ViewModelFactory.FromPalette(pal, !vt.IsTargetReplaceable),
                SerializationHelper.DeserializeColorPalette,
                SerializationHelper.SerializeColorPalette);
