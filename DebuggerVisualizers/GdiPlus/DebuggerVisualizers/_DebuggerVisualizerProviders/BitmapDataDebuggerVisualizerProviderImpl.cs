...
///////////////////////////////////////////////////////////////////////////////
//  File: BitmapDataDebuggerVisualizerProviderImpl.cs
///////////////////////////////////////////////////////////////////////////////
...
{
    /// <summary>
    /// Provides the implementation of a debugger visualizer extension for the <see cref="BitmapData"/> class.
    /// </summary>
    public class BitmapDataDebuggerVisualizerProviderImpl : IDebuggerVisualizerProvider
    {
        #region Properties
        ...
        public DebuggerVisualizerProviderConfiguration DebuggerVisualizerProviderConfiguration
            => new("KGy SOFT BitmapData Debugger Visualizer", typeof(BitmapData))
        {
            Style = VisualizerStyle.ToolWindow,
            VisualizerObjectSourceType = new VisualizerObjectSourceType(typeof(BitmapDataSerializer))
        };
        ...
        public async Task<IRemoteUserControl> CreateVisualizerAsync(VisualizerTarget visualizerTarget, CancellationToken cancellationToken)
        {
            ...
            var result = new VisualizerExtensionWpfAdapter<BitmapDataInfo?>(visualizerTarget,
                (info, _) => ViewModelFactory.FromBitmapData(info),
                SerializationHelper.DeserializeBitmapDataInfo, null);
