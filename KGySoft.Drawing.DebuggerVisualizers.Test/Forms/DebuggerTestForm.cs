...
namespace KGySoft.Drawing.DebuggerVisualizers.Test.Forms
{
    public partial class DebuggerTestForm: Form
    {
        ...
        {
            string fileName = ucCustomSelector1.Text;
        ...
        private void advancedRadioButton2_CheckedChanged(object sender, EventArgs e)
        {
            if (!advancedRadioButton2.Checked)
                return;
        ...
        private void advancedRadioButton3_CheckedChanged(object sender, EventArgs e)
        {
            if (!advancedRadioButton3.Checked)
                return;
        ...
        private void advancedRadioButton4_CheckedChanged(object sender, EventArgs e)
        {
            if (!advancedRadioButton4.Checked)
                return;
        ...
        private void advancedRadioButton6_CheckedChanged(object sender, EventArgs e)
        {
            if (!advancedRadioButton6.Checked)
                return;
        ...
        private void advancedRadioButton7_CheckedChanged(object sender, EventArgs e)
        {
            if (!advancedRadioButton7.Checked)
                return;
        ...
        private void advancedButton3_Click(object sender, EventArgs e)
        {
            using (Graphics g = Graphics.FromHwnd(Handle))
            {
                ...
                g.SetClip(ucCustomSelector1.Bounds, CombineMode.Intersect);
