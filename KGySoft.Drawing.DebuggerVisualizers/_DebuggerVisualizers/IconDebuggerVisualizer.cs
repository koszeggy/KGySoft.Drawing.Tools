...
namespace KGySoft.Drawing.DebuggerVisualizers
{
    internal sealed class IconDebuggerVisualizer : DialogDebuggerVisualizer
    {
        ...
        {
            ImageReference replacementObject = DebuggerHelper.DebugIcon(SerializationHelper.DeserializeIcon(objectProvider.GetData()), objectProvider.IsObjectReplaceable);
