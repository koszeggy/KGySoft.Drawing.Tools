...
namespace KGySoft.Drawing.DebuggerVisualizers
{
    internal sealed class IconDebuggerVisualizer : DialogDebuggerVisualizer
    {
        ...
        {
            ImageReference replacementObject = DebuggerHelper.DebugIcon(SerializationHelper.DeserializeImageInfo(objectProvider.GetData()), objectProvider.IsObjectReplaceable);
