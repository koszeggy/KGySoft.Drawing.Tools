...
namespace KGySoft.Drawing.DebuggerVisualizers
{
    internal sealed class BitmapDebuggerVisualizer : DialogDebuggerVisualizer
    {
        ...
        {
            ImageReference replacementObject = DebuggerHelper.DebugBitmap(SerializationHelper.DeserializeImage(objectProvider.GetData()), objectProvider.IsObjectReplaceable);
