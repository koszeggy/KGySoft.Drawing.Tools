...
///////////////////////////////////////////////////////////////////////////////
//  File: BitmapDebuggerVisualizer.cs
///////////////////////////////////////////////////////////////////////////////
...
namespace KGySoft.Drawing.DebuggerVisualizers
{
    internal sealed class BitmapDebuggerVisualizer : DialogDebuggerVisualizer
    {
        ...
        {
            ImageReference replacementObject = DebuggerHelper.DebugBitmap(SerializationHelper.DeserializeImageInfo(objectProvider.GetData()), objectProvider.IsObjectReplaceable);
