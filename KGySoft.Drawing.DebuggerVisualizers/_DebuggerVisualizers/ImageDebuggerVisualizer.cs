...
namespace KGySoft.Drawing.DebuggerVisualizers
{
    internal sealed class ImageDebuggerVisualizer : DialogDebuggerVisualizer
    {
        ...
        {
            ImageReference replacementObject = DebuggerHelper.DebugImage(SerializationHelper.DeserializeImage(objectProvider.GetData()), objectProvider.IsObjectReplaceable);
