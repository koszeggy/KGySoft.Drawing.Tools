...
namespace KGySoft.Drawing.DebuggerVisualizers.Serialization
{
    ...
    internal class IconSerializer : VisualizerObjectSource
    {
        ...
        /// </summary>
        public override object? CreateReplacementObject(object target, Stream incomingData) => SerializationHelper.DeserializeImageInfo(incomingData).GetCreateIcon();
