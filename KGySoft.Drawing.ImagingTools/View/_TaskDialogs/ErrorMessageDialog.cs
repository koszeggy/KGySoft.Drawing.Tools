...
{
    internal class ErrorMessageDialog : MessageDialogBase
    {
        #region Properties
        ...
        internal ErrorMessageDialog(ErrorMessageViewModel viewModel) : base(viewModel)
        {
