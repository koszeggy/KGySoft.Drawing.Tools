...
{
    internal class DithererStrengthEditor : UITypeEditor
    {
        #region Properties
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            using var editorControl = new DithererStrengthEditorControl(editorService, originalValue);
            ...
            return originalValue.Equals(editorControl.Value) ? value : editorControl.Value;
        }
